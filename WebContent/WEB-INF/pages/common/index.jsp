...
<script type="text/javascript">
	...
	$(function() {
		var setting = {
			...
			callback : {
				onClick : onClick//为ztree上的节点绑定单击事件
			}
		};
...
<body class="easyui-layout">
    ...
    <div id="editPwdWindow" class="easyui-window" title="修改密码" collapsible="false" minimizable="false"
    	 modal="true" closed="true" resizable="false"
                ...
                <form id="editPasswordForm">
	                <table cellpadding=3>
	                    <tr>
	                        <td>新密码：</td>
	                        <td><input
	                        	data-options="required:true,validType:'length[4,6]'"
	                         id="txtNewPass" type="Password" class="txt01 easyui-validatebox" /></td>
	                    </tr>
	                    <tr>
	                        <td>确认密码：</td>
	                        <td><input
                ...
                <script type="text/javascript">
                	$(function(){
                		...
                		$("#btnEp").click(function(){
                			//进行表单校验，如果校验通过，发送ajax请求，修改密码,如果校验不通过，提示错误信息
                			...
                			if(v){
                				...
                				if(v1 == v2){
	                				...
	                				$.post(url,{"password":v2},function(data){
	                					//关闭修改密码窗口
	                					$("#editPwdWindow").window("close");
	                					if(data=='0'){
	                						//修改失败，弹出提示
	                				...
	                				$.messager.alert("提示信息","两次密码输入有误！","warning");
                				}
                			}
                		});
                	});
