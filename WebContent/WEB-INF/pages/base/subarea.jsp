...
<script type="text/javascript">
	...
	//导出按钮绑定的事件
	function doExport(){
		//发送http请求get，请求服务端，查询所有的分区数据，写入到Excel表格中，提供客户端下载
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addSubareaForm" action="${pageContext.request.contextPath }/subareaAction_add.action"
				 method="post">
							...
							<script type="text/javascript">
								$(function(){
									...
									$("#btn").click(function(){
										...
										//调用datagrid的load方法,重新发送ajax请求,提交参数作为过滤条件
